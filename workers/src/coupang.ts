...
export async function registerCoupangProduct(
  ...
  const payload = {
    ...
    returnAddress: env.COUPANG_RETURN_ADDRESS || returnPlace.address || undefined,
    returnAddressDetail: env.COUPANG_RETURN_ADDRESS_DETAIL || returnPlace.addressDetail || undefined,
    returnChargePersonName: env.COUPANG_RETURN_CONTACT_NAME || returnPlace.contactName || undefined,
    returnChargePersonPhoneNumber: env.COUPANG_RETURN_PHONE || returnPlace.phoneNumber || undefined,
